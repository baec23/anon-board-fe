...
export const StringStore_en: StringStore = {
    btn_cancel: 'Cancel',
    btn_confirm: 'Confirm',
    btn_create: 'Create',
    btn_addReply: 'Add Reply',
    ...
    messageBoard_lbl_addReply: 'Add reply',
    messageBoard_ph_addReply: 'Add a reply...',
    messageBoard_txt_seeMore: 'See more...',
    messageBoard_txt_seeLess: 'See less...',
